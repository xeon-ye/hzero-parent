...
public interface MessageRemoteService {
     ...
     * @return 发送结果
     */
    @PostMapping("/{organizationId}/message/relevance")
    ResponseEntity<Void> sendMessage(@PathVariable("organizationId") long tenantId,
                                     @RequestBody MessageSender messageSender);
     ...
     * @return 发送结果
     */
    @PostMapping("/{organizationId}/message/relevance/all")
    ResponseEntity<Void> sendAllMessage(@PathVariable("organizationId") long tenantId,
    ...
    ResponseEntity<List<TemplateServerLine>> listTemplateServerLine(@PathVariable("organizationId") Long tenantId,
