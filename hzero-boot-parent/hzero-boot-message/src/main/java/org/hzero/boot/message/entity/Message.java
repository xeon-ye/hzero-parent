...
public class Message {
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(messageId, tenantId, messageTypeCode, lang, templateCode, serverCode, subject, content, sendFlag, transactionId, trxStatusCode, sendDate, externalCode, serverTypeCode, receiverList, sendArgs, targetUserTenantId);
    }
