...
public class MessageRemoteImpl implements MessageRemoteService {
    ...
    @Override
    public ResponseEntity<String> queryReceiver(long tenantId, String typeCode, Map<String, String> args) {
    ...
    @Override
    public ResponseEntity<Void> sendMessage(long tenantId, MessageSender messageSender) {
    ...
    @Override
    public ResponseEntity<Void> sendAllMessage(long tenantId, AllSender sender) {
        logger.error("Error send message, params[tenantId = {}, sender = {}]", tenantId, sender);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).build();
    }

    @Override
    public ResponseEntity<List<TemplateServerLine>> listTemplateServerLine(Long tenantId, String messageCode) {
