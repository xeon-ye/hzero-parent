...
public class LovSqlController extends BaseController {
    ...
    private Logger logger = LoggerFactory.getLogger(LovSqlController.class);
    ...
    public ResponseEntity getSqlTranslationData(
            ...
            @RequestParam String lovCode) {
        try {
            return Results.success(this.lovSqlHandler.queryTranslationData(lovCode, organizationId, params));
        } catch (Exception e) {
            return this.handleException(e);
        }
    }
