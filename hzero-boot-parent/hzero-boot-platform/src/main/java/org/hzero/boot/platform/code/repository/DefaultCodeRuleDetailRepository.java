...
public class DefaultCodeRuleDetailRepository implements CodeRuleDetailRepository {
    ...
    public List<CodeRuleDetail> listCodeRuleFromDatabase(DefaultCodeRuleBuilder.CodeRuleKey codeRuleKey) {
        ...
        if (previousCodeRuleKey != null) {
            previousLevelValue = (CodeConstants.CodeRuleLevelCode.COMPANY.equals(previousCodeRuleKey.getLevelCode()) || CodeConstants.CodeRuleLevelCode.CUSTOM.equals(previousCodeRuleKey.getLevelCode())) ?
                    previousCodeRuleKey.getLevelValue() : String.valueOf(previousCodeRuleKey.getTenantId());
        }
