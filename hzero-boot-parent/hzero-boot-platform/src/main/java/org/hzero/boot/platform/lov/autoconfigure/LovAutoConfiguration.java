...
public class LovAutoConfiguration {
    ...
    public LovAdapter lovAdapter(RedisHelper redisHelper, LovFeignClient lovFeignClient, ObjectMapper objectMapper, RestTemplate restTemplate) {
        return new DefaultLovAdapter(redisHelper, lovFeignClient, objectMapper, restTemplate);
    }
