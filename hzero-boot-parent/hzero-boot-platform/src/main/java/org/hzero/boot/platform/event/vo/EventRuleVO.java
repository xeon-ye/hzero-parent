...
public class EventRuleVO implements Serializable {
    ...
    public String toString() {
        return "{" + "eventRuleId=" + eventRuleId + ", eventId=" + eventId + ", syncFlag=" + syncFlag + ", callType='"
                        + callType + '\'' + ", beanName='" + beanName + '\'' + ", methodName='" + methodName + '\''
                        + ", apiUrl='" + apiUrl + '\'' + ", orderSeq=" + orderSeq + ", matchingRule='" + matchingRule + '\''
                        + ", enabledFlag=" + enabledFlag + ", resultFlag=" + resultFlag + '}';
    }
}
