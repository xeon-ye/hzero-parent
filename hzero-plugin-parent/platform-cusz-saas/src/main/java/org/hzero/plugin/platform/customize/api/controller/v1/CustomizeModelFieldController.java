 ...
 */
@Api(tags = CuszPlatformSwaggerApiConfig.CUSZ_MODEL_FIELD)
@RestController("customizeModelFieldController.v1")
@RequestMapping("/v1/{organizationId}/model/field")
public class CustomizeModelFieldController {
