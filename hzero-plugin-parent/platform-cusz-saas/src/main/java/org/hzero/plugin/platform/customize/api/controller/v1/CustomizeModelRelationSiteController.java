 ...
 */
@Api(tags = CuszPlatformSwaggerApiConfig.CUSZ_MODEL_RELATION_SITE)
@RestController("customizeModelRelationSiteController.v1")
@RequestMapping("/v1/model/relation")
public class CustomizeModelRelationSiteController {
