 ...
 */
@RestController("customizeModelController.v1")
@RequestMapping("/v1/{organizationId}/customize/model")
@Api(tags = {CuszPlatformSwaggerApiConfig.CUSZ_MODEL})
public class CustomizeModelController {
