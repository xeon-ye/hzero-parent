...
public class RegionDTO extends Child<RegionDTO> implements SecurityToken {
    @Encrypt
    ...
    public RegionDTO setFlex(Map<String, Object> flex) {
        this.flex = flex;
        return this;
    }
    ...
    public RegionDTO setRegionId(Long regionId) {
    ...
    public RegionDTO setRegionCode(String regionCode) {
    ...
    public RegionDTO setParentRegionId(Long parentRegionId) {
    ...
    public RegionDTO setEnabledFlag(Integer enabledFlag) {
    ...
    public RegionDTO setObjectVersionNumber(Long objectVersionNumber) {
    ...
    public RegionDTO setChildren(List<RegionDTO> children) {
    ...
    public RegionDTO setLevelPath(String levelPath) {
    ...
    public RegionDTO setQuickIndex(String quickIndex) {
