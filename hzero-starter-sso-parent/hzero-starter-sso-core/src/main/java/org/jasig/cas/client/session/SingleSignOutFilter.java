...
public final class SingleSignOutFilter extends AbstractConfigurationFilter {
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        ...
        if (!isIgnoreInitConfiguration()) {
            ...
            HANDLER.setCasLoginProcessors(casLoginProcessors);
            HANDLER.setCasLogoutProcessors(casLogoutProcessors);
        }
        HANDLER.init();
    ...
    public void setCasLoginProcessors(List<CasLoginProcessor> casLoginProcessors) {
        ...
        this.casLoginProcessors.sort(Comparator.comparingInt(CasLoginProcessor::getOrder));
    }
    ...
    public void setCasLogoutProcessors(List<CasLogoutProcessor> casLogoutProcessors) {
        ...
        this.casLogoutProcessors.sort(Comparator.comparingInt(CasLogoutProcessor::getOrder));
    }
