...
public class EnhancedRedisRateLimiter extends AbstractRateLimiter<EnhancedRedisRateLimiter.Config> implements ApplicationContextAware {
    ...
    public Integer getReplenishRate(Config config, String id){
    ...
    public Integer getBurstCapacity(Config config, String id){
    ...
    public HashMap<String, String> getHeaders(Config config, String id, Long tokensLeft) {
