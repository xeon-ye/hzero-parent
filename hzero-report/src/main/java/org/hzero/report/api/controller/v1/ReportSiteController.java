...
public class ReportSiteController extends BaseController {
    ...
    public JSONObject getReportData(@PathVariable("reportUuid") String reportUuid, final HttpServletRequest request) {
    ...
    public ResponseEntity createRequest(@PathVariable("reportUuid") String reportUuid, Long tenantId, final HttpServletRequest request) {
