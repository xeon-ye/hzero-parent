...
public class CaptchaMessageHelper {
     ...
     * @return Captcha 封装
     * @see CaptchaMessageHelper#generateMobileCaptcha(String, String, UserType, String)
     */
     ...
     * @param userType           用户类型
     * @return Captcha 封装
     * @see CaptchaMessageHelper#generateMobileCaptcha(String, String, UserType, String, String)
     */
     ...
     * @param captchaCachePrefix 缓存前缀
     * @return Captcha 封装
     * @see CaptchaMessageHelper#generateMobileCaptcha(String, UserType, String, String)
     */
    public CaptchaResult generateMobileCaptcha(String crownCode, String mobile, UserType userType,
     ...
     * @param captchaCachePrefix 缓存前缀
     * @return Captcha 封装
     * @see CaptchaMessageHelper#generateMobileCaptcha(String, UserType, String)
     */
     ...
     * @param captchaCachePrefix 缓存前缀
     * @return Captcha 封装
     * @see CaptchaMessageHelper#generateEmailCaptcha(String, UserType, String)
     */
     ...
     * @param captchaCachePrefix 缓存前缀
     * @return Captcha
     * @see CaptchaMessageHelper#generateEmailCaptcha(String, UserType, String, String)
     */
     ...
     * @return Captcha 封装
     * @see CaptchaMessageHelper#checkCaptcha(String, String, UserType, String, boolean)
     */
     ...
     * @param cacheCheckResult   是否缓存验证结果
     * @return Captcha 封装
     * @see CaptchaMessageHelper#checkCaptcha(String, String, UserType, String, String, boolean)
     */
     ...
     * @return Captcha 封装
     * @see CaptchaMessageHelper#checkCaptcha(String, String, String, UserType, String, boolean)
     */
     ...
     * @param cacheCheckResult   是否缓存验证结果，缓存则返回缓存了验证结果的KEY
     * @return Captcha 封装
     * @see CaptchaMessageHelper#checkCaptcha(String, String, String, UserType, String, String, boolean)
     */
    public CaptchaResult checkCaptcha(String captchaKey, String captcha, String number,
     ...
     * @param captchaCachePrefix 缓存前缀
     * @see CaptchaMessageHelper#checkLastResult(String, UserType, String, String)
     */
     ...
     * @param cachePrefix cache prefix.
     * @return {@link CaptchaResult#FIELD_LAST_CHECK_KEY}
     * @see CaptchaMessageHelper#cacheCheckResult(String, UserType, String, String)
     */
