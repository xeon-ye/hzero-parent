...
public class EncryptPathVariableMethodArgumentResolver extends PathVariableMethodArgumentResolver {
    ...
    protected Object resolveName(String name, MethodParameter parameter, NativeWebRequest request) throws Exception {
        ...
        if (EncryptContext.isEncrypt()
                ...
                && !EncryptUtils.ignoreValue(parameter.getParameterAnnotation(Encrypt.class), (String) value)) {
            value = encryptionService.decrypt((String) value, parameter.getParameterAnnotation(Encrypt.class).value());
        }
        return value;
    }
